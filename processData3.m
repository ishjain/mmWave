%processData3 Feb 27 based on mu =20
%processData2
%processData
...
for i=1:nFiles
    data(:,:,i)=csvread(strcat('Data3/output',int2str(i),'.csv'));
end
data(isnan(data))=0;
...
print(h,[pwd '/figures/20muprob_all_bl_new.pdf'],'-dpdf','-r0')
print(h,[pwd '/figures/20muprob_all_bl_new.png'],'-dpng','-r0')
...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(h,[pwd '/figures/20muavg_freq_new.pdf'],'-dpdf','-r0')
print(h,[pwd '/figures/20muavg_freq_new.png'],'-dpng','-r0')
...
pos = get(h,'Position');
set(h,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(h,[pwd '/figures/20muavg_dur_new.pdf'],'-dpdf','-r0')
print(h,[pwd '/figures/20muavg_dur_new.png'],'-dpng','-r0')

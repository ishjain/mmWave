...
grid on;
for j=1:5
semilogx(densityAP*10^4, probAllBl(j,:),'color',color{j},'LineWidth',2)
hold on;
end
for j=1:5
semilogx(densityAP*10^4, th_probAllBl(j,:),'color',color{j},'LineStyle','--','LineWidth',2)
hold on;
end
...
grid on;
for j=1:5
semilogx(densityAP*10^4, avgFreq(j,:),'color',color{j},'LineWidth',2)
hold on;
end
for j=1:5
semilogx(densityAP*10^4, th_freqBl(j,:),'color',color{j},'LineStyle','--','LineWidth',2)
hold on;
end
g=legend('\rho_b=0.01 bl/m^2','\rho_b=0.1 bl/m^2','\rho_b=0.2 bl/m^2',...
    '\rho_b=0.5 bl/m^2','\rho_b=0.65 bl/m^2' );
...
grid on;
for j=1:5
semilogx(densityAP*10^6, avgDur(j,:),'color',color{j},'LineWidth',2)
hold on;
end
for j=1:5
semilogx(densityAP*10^6, th_durBl(j,:),'color',color{j},'LineStyle','--','LineWidth',2)
hold on;
end
g=legend('\rho_b=0.01 bl/m^2','\rho_b=0.1 bl/m^2','\rho_b=0.2 bl/m^2',...
    '\rho_b=0.5 bl/m^2','\rho_b=0.65 bl/m^2' );
